...
// Fetch the number of meetings for a given connection and company UID
export async function fetchMeetingCountForConnectionAndCompany(connectionId: string, companyUID: string) {
